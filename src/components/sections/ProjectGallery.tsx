          ...
          >
            <div className="overflow-hidden rounded-2xl border border-white/20 bg-white/90 shadow-2xl backdrop-blur-2xl dark:border-slate-700/50 dark:bg-slate-900/90">
              ...
              <div className="px-6 pt-5 pb-2 text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-100 dark:bg-cyan-950/50">
                  <ExternalLink className="h-6 w-6 text-primary-500 dark:text-cyan-400" />
                </div>
...
export function ProjectGallery() {
  ...
  const projectItems = items.slice(0, 4);
