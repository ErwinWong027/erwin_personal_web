...
export function BeforeAfterComparison() {
  ...
  const comparisons = [
    {
      titleKey: "comparison1_title" as const,
      beforeKey: "comparison1_before" as const,
      afterKey: "comparison1_after" as const,
      descKey: "comparison1_desc" as const,
    },
    {
      titleKey: "comparison2_title" as const,
      beforeKey: "comparison2_before" as const,
      afterKey: "comparison2_after" as const,
      descKey: "comparison2_desc" as const,
    },
    {
      titleKey: "comparison3_title" as const,
      beforeKey: "comparison3_before" as const,
      afterKey: "comparison3_after" as const,
      descKey: "comparison3_desc" as const,
    },
  ];

  return (
    <AnimateOnScroll className="mt-20">
      <h3 className="mb-8 text-center text-2xl font-bold">{t("comparison_title")}</h3>
          ...
          <div key={comparison.titleKey} className="rounded-2xl bg-slate-50 p-6 dark:bg-slate-900/50">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border-2 border-dashed border-slate-300 bg-white p-8 text-center dark:border-slate-700 dark:bg-slate-800">
                ...
                <p className="mt-4 text-xs text-slate-400 dark:text-slate-500">{t("comparison_placeholder")}</p>
              </div>
              <div className="rounded-xl border-2 border-dashed border-slate-300 bg-white p-8 text-center dark:border-slate-700 dark:bg-slate-800">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-xl bg-slate-100 mx-auto dark:bg-slate-700">
                  <ImageIcon className="h-8 w-8 text-slate-400" />
